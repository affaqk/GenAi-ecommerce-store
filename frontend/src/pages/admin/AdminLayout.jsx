...
const AdminLayout = () => {
  ...
  return (
    <div className="h-screen bg-slate-50 flex overflow-hidden">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-slate-900 z-30 flex flex-col transition-transform duration-300 shrink-0
          ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:z-auto`}
      >
        {/* Logo */}
        <div className="flex items-center gap-2.5 px-6 h-16 border-b border-slate-700/60 shrink-0">
          ...
          <div>
            <span className="text-white font-bold text-base tracking-tight">Luxora</span>
            <p className="text-slate-400 text-[10px] leading-none mt-0.5 tracking-widest uppercase">Admin</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 shrink-0 sticky top-0 z-10">
          <button
            className="lg:hidden p-2 text-slate-600 hover:text-amber-500 transition-colors"
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-xs text-slate-400">affaq020@gmail.com</p>
            </div>
